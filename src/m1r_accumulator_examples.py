...
#
#              for k in range(r - s): r-s should be be n
#                  count = 0       r or s = count
#                  if math.cos(r) > 0: no s for use
#                      count = 1      count = count + 1
#                  return count will return 1
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean? loop variable that is not used
#
